...
void AppClass::ProcessKeyboard(sf::Event a_event)
{
	...
	if (a_event.key.code == sf::Keyboard::Key::C) {
		EnableComplimentary = !EnableComplimentary;
	}
...
void AppClass::Display(void)
{
	...
	GLuint EnableComplimentary = glGetUniformLocation(m_uShaderProgramID, "Complimentary");
	glUniform1i(EnableComplimentary, EnableComplimentary);
